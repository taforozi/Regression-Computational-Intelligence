...
fprintf('Metrics for TSK Model 3 \n');
fprintf('MSE: %f\n', MSE);
fprintf('RMSE: %f\n', RMSE);
fprintf('R^2: %f\n', R2);
fprintf('NMSE: %f\n', NMSE);
...
title('Model 3 - Output','Interpreter','latex');
xlabel('Number of Iterations','Interpreter','Latex'); 
ylabel('y, $$\hat{y}$$','Interpreter','Latex');
subplot(1,2,2);
plot(abs(check_data(1:100,end) - y(1:100)), 'LineWidth', 1.5);
title('Model 3 - Prediction error','Interpreter','latex');
xlabel('Number of Iterations','Interpreter','Latex'); 
ylabel('Error','Interpreter','Latex');
...
figure;
hold on;
title('Model 3 - Predictions and Real values','Interpreter','Latex');
