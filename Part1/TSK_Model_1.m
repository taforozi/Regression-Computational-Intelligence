...
opt.InputMembershipFunctionype = "gbellmf";
...
fprintf('Metrics for TSK Model 1 \n');
fprintf('MSE: %f\n', MSE);
fprintf('RMSE: %f\n', RMSE);
fprintf('R^2: %f\n', R2);
fprintf('NMSE: %f\n', NMSE);
...
title('Model 1 - Output','Interpreter','latex');
xlabel('Number of Iterations','Interpreter','Latex'); 
...
figure;
hold on;
title('Model 1 - Predictions and Real values','Interpreter','Latex');
